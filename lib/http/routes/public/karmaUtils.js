...
define([], function defineKarmaUtils() {
  ...
  function retrieveAllBuiltfiles(moduleName, callback) {
    ...
    require([ 'baja' ], function () {
      // a failed require for baja! will not call the callback when run in ci mode, but quits
      // immediately. a failed require for baja correctly calls the callback.
